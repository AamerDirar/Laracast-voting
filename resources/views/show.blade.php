<x-app-layout>
    <div>
        <a href="/" class="a flex items-center font-semibold hover:underline">
        ...
        <div class="flex flex-1 px-4 py-6">
            ...
            <div class="w-full mx-4">
                ...
                <div class="text-gray-600 mt-3">
                    Lorem ipsum dolor sit amet consectetur. Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore itaque adipisci tenetur magni facere unde aperiam accusantium ab dolorum nostrum, dolorem vitae distinctio ipsum aliquam quod assumenda qui animi doloribus.
                </div>
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <div class="flex items-center space-x-2">
                        <div class="bg-gray-200 text-xxs font-bold uppercase leading-none border rounded-full text-center w-28 h-7 py-2 px-4">Open</div>
    ...
    <div class="comments-container relative space-y-6 ml-22 pt-4 my-8 mt-1">
        ...
        <div class="comment-container relative bg-white rounded-xl flex mt-4 is-admin">
            <div class="flex flex-1 px-4 py-6">
                <div class="flex-none">
                    <a href="#" class="flex-none">
